...
export class UIManager {
    ...
    toggleColorCheckboxes(disabled) {
        ...
        const colorCheckboxes = document.querySelectorAll('#colorList input[type="checkbox"]');
        ...
        colorCheckboxes.forEach(checkbox => {
            ...
            if (disabled) {
                checkbox.setAttribute('aria-label', `${checkbox.nextElementSibling.nextElementSibling.textContent} - Unavailable while background colour is locked`);
            } else {
        ...
        if (selectAllCheckbox) {
            ...
            if (disabled) {
                selectAllCheckbox.setAttribute('aria-label', 'Select all colours - Unavailable while background colour is locked');
            } else {
